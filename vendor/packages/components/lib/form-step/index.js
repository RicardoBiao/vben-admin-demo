...
var Step = ant_design_vue_1.Steps.Step;
var parseSteps = function (schema) {
  var steps = [];
  schema.mapProperties(function (schema, name) {
    var _a;
    if (
      ((_a = schema['x-component']) === null || _a === void 0 ? void 0 : _a.indexOf('StepPane')) >
      -1
    ) {
      steps.push({
        name: name,
    ...
    submit: function (onSubmit) {
      ...
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_c) {
          return [
            2 /*return*/,
            (_b = (_a = env.form) === null || _a === void 0 ? void 0 : _a.submit) === null ||
            _b === void 0
              ? void 0
              : _b.call(_a, onSubmit),
          ];
...
var FormStepInner = (0, reactive_vue_1.observer)(
  ...
  (0, vue_1.defineComponent)({
    ...
    setup: function (props, _a) {
      ...
      var fieldSchemaRef = (0, vue_2.useFieldSchema)();
      ...
      return function () {
        ...
        var current =
          props.current ||
          ((_a = props.formStep) === null || _a === void 0 ? void 0 : _a.current) ||
          0;
            ...
            default: function () {
              return [
                  ...
                  },
                  {
                    default: function () {
                      return renderSteps(steps, function (_a, key) {
                        var props = _a.props;
                        return (0, vue_1.h)(Step, { props: props, key: key }, {});
                      });
                    },
                  },
                ),
                renderSteps(steps, function (_a, key) {
                  ...
                  return (0,
                  vue_1.h)(vue_2.RecursionField, { name: name, schema: schema, key: key }, {});
                }),
              ];
            },
          },
...
// eslint-disable-next-line vue/one-component-per-file
var StepPane = (0, vue_1.defineComponent)({
  name: 'FormStepPane',
