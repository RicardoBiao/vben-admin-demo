...
var createContext = function (defaultValue) {
  ...
  return {
    Provider: (0, vue_1.defineComponent)({
      ...
      setup: function (props, _a) {
        var slots = _a.slots;
        var value = (0, vue_1.toRef)(props, 'value');
        (0, vue_1.provide)(injectKey, (0, vue_1.readonly)(value));
        return function () {
          var _a;
    ...
    Consumer: (0, vue_1.defineComponent)({
      name: 'ContextConsumer',
      setup: function (_props, _a) {
        var slots = _a.slots;
        var value = (0, vue_1.inject)(injectKey);
        return function () {
          var _a;
          return (_a = slots === null || slots === void 0 ? void 0 : slots.default) === null ||
            _a === void 0
...
var useContext = function (context) {
  ...
  return (0, vue_1.inject)(key, (0, vue_1.ref)(null));
};
