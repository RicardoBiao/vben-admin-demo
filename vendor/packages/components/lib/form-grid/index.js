...
exports.FormGrid = exports.useGridColumn = exports.useFormGrid = exports.createFormGrid = void 0;
...
var useFormGrid = function () {
  return (0, vue_2.inject)(FormGridSymbol);
};
...
var FormGridInner = (0, reactive_vue_1.observer)(
  ...
  (0, vue_1.defineComponent)({
    ...
    setup: function (props) {
      ...
      var gridInstance = (0, vue_1.computed)(function () {
        var _a, _b, _c, _d;
        var newProps = {};
        ...
        var options = __assign(
          {
            columnGap:
              (_b = (_a = layout.value) === null || _a === void 0 ? void 0 : _a.gridColumnGap) !==
                null && _b !== void 0
                ? _b
                : 8,
            rowGap:
              (_d = (_c = layout.value) === null || _c === void 0 ? void 0 : _c.gridRowGap) !==
                null && _d !== void 0
                ? _d
                : 4,
          },
      ...
      (0, vue_1.provide)(FormGridSymbol, gridInstance);
      (0, vue_1.onMounted)(function () {
        (0, vue_1.watchEffect)(function (onInvalidate) {
