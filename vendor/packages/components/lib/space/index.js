...
exports.Space = (0, vue_1.defineComponent)({
  name: 'Space',
  ...
  setup: function (props, _a) {
    ...
    return function () {
      ...
      var align = props.align,
        ...
        size =
          _g === void 0
            ? (_c = (_b = layout.value) === null || _b === void 0 ? void 0 : _b.spaceGap) !==
                null && _c !== void 0
              ? _c
              : 'small'
            : _g,
      ...
      var prefixCls = 'ant-space';
      var children = (_d = slots.default) === null || _d === void 0 ? void 0 : _d.call(slots);
      var items = [];
      if (Array.isArray(children)) {
        if (children.length === 1) {
          if (
            (_e = children[0]['tag']) === null || _e === void 0 ? void 0 : _e.endsWith('Fragment')
          ) {
            // Fragment hack
            items =
          ...
          'div',
          {
            ...
            style:
              i === len - 1
                ? {}
                : ((_a = {}),
                  (_a[direction === 'vertical' ? 'marginBottom' : marginDirection] =
                    typeof size === 'string'
