...
export var useFormLayout = function () {
  ...
  var formLayout = ref(__assign(__assign({}, deepLayout.value), shallowLayout.value));
  watch(
...
export var FormLayout = defineComponent({
  ...
  setup: function (customProps, _a) {
    var slots = _a.slots;
    var props = useResponsiveFormLayout(customProps).props;
    var deepLayout = useFormDeepLayout();
    var newDeepLayout = ref(__assign({}, deepLayout.value));
